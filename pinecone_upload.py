...
# Initialize clients
# -----------------------------
client = OpenAI(api_key=config.OPENAI_API_KEY)  # OpenAI v2 client
pc = Pinecone(api_key=config.PINECONE_API_KEY)  # Pinecone serverless client

# -----------------------------
# Create managed index if it doesn't exist
# -----------------------------
existing_indexes = pc.list_indexes()  # <- fixed: returns list of strings
...
def get_embeddings(texts, model="text-embedding-3-small"):
    """
    Generate embeddings using OpenAI v2 client.
